...
export default function DocsPage() {
  return (
    ...
    {/* Footer */}
    <footer className="relative z-20 py-3">
      <div className="max-w-4xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="text-center sm:text-left">
          <p className="retro-footer" style={{ color: "#1a1a2e" }}>MIRAGE &copy; 2026</p>
          <p className="retro-footer" style={{ color: "#4a4a6a", fontSize: 6 }}>Anti-adversarial intelligence for BNB Chain</p>
        </div>
        <div className="flex flex-wrap justify-center gap-3">
          <a href="/docs" className="retro-footer" style={{ color: "#1a1a2e", textDecoration: "none" }}>DOCS</a>
          <a href="https://dorahacks.io/buidl/43379" target="_blank" rel="noopener noreferrer" className="retro-footer" style={{ color: "#1a1a2e", textDecoration: "none" }}>DORAHACKS</a>
          <a href="https://github.com/SAHU-01/Mirage" target="_blank" rel="noopener noreferrer" className="retro-footer" style={{ color: "#1a1a2e", textDecoration: "none" }}>GITHUB</a>
        </div>
        <div className="flex items-center gap-2">
          <a href="https://github.com/SAHU-01/Mirage" target="_blank" rel="noopener noreferrer" title="GitHub" style={{ width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #1a1a2e", background: "#f5f0e8" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1a1a2e"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57A12.02 12.02 0 0024 12c0-6.63-5.37-12-12-12z"/></svg>
          </a>
          <a href="https://t.me/Mirage4memeBot" target="_blank" rel="noopener noreferrer" title="Telegram Bot" style={{ width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #1a1a2e", background: "#f5f0e8" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1a1a2e"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
          </a>
          <a href="https://x.com/asahu_dev" target="_blank" rel="noopener noreferrer" title="Ankita on X" style={{ width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #1a1a2e", background: "#f5f0e8" }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="#1a1a2e"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://www.linkedin.com/in/nikhil-kumar-18067a196/" target="_blank" rel="noopener noreferrer" title="Nikhil on LinkedIn" style={{ width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", border: "2px solid #1a1a2e", background: "#f5f0e8" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1a1a2e"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
          </a>
        </div>
      </div>
    </footer>
